...
function process_generators(generators::DataFrame,
                            capacity::Matrix, λ::Matrix, μ::Matrix)
...
h5open(inputpath_h5, "r") do h5file
    ...
    generators_specs, generators_regionstart, timestamps_generatorset =
        process_generators(generators[:, !isvg], dispatchable_capacity, λ, μ)
